...
class ImageHomographyMaskDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: str=None) -> None:
        if stage == "fit" or stage is None:
            self._train_ds = ImageHomographyMaskDataset(self._train_df, self._prefix, self._rho, self._train_tranforms, seeds=False)
            self._val_ds = ImageHomographyMaskDataset(self._val_df, self._prefix, self._rho, self._val_tranforms, seeds=True)
        if stage == "test":
            self._test_ds = ImageHomographyMaskDataset(self._test_df, self._prefix, self._rho, self._test_tranforms, seeds=True)
