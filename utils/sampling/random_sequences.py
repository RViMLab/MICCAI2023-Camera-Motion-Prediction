...
class RandomSequences():
    ...
    """
    def __init__(self, max_seq: int, paths: List[str], seq_len: int=1, strides: List[int]=[1], transforms: Callable=None, verbose: bool=False) -> None:
    ...
    def _sample(self, capture: cv2.VideoCapture, frame: int, stride: int=1, transforms: Callable=None) -> Union[np.ndarray, torch.Tensor]:
