...
from utils.transforms import HOMOGRAPHY_RETURN, EndoscopyEllipsoid, RandomEdgeHomography
...
class ImagePairHomographyEndoscopyViewDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img_crp, wrp_crp = self._ee.movingCenterPipeline(
            ...
            min_rot=self._min_rot,
            max_rot=self._max_rot,
            dc_scale=self._dc_scale,
            dori=self._dori,
            update_chance=self._update_chance,
            seed=seed,
        )
